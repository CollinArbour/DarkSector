...
# with command line options: step2 --filein file:S1_DIGI_HLT_mA_0p5.root --fileout file:S2_RECO_mA_0p5.root --mc --eventcontent AODSIM --datatier AODSIM --conditions 124X_mcRun3_2022_realistic_postEE_v1 --step RAW2DIGI,L1Reco,RECO,RECOSIM --procModifiers siPixelQualityRawToDigi --nThreads 8 --python_filename step2.py --era Run3 --customise Configuration/DataProcessing/Utils.addMonitoring -n 10000 --geometry DB:Extended --no_exec
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:S1_DIGI_HLT_mA_0p5.root'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:S2_RECO_mA_0p5.root'),

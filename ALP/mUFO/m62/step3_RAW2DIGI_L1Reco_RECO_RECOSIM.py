...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:mUFO_ALP_m62_SIM_DIGI-HLT.root'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:mUFO_ALP_m62_AOD.root'),
